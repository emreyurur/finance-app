...
export default function TransactionItem({
  ...
  return (<div className="w-full flex items-center">
    ...
    <div className="min-w-[100px] flex justify-end">
      <Link href={`/dashboard/transaction/${id}/edit`} className="px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-800 rounded">
        <Pencil className="w-4 h-4" />
      </Link>
      <TransactionItemRemoveButton id={String(id)} onRemoved={onRemoved} />
    </div>
  </div>)
}